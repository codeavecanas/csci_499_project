...
def cars_com_scrape(url):
    ...
    #Parsing through car info
    #For now, we're going through the first 10 pages
    #I will add something to input this or do it automatically later, the page number thing for cars.com sucks.
    pagenum = 5
...
test = cars_com_scrape('https://www.cars.com/shopping/results/?page=1&page_size=100&list_price_max=&makes[]=audi&maximum_distance=20&stock_type=new_cpo&zip=10000')